...
### Additional Remark ###
      ...
      (7) Because the 'simMCN.r' and 'simMCNR.r' R scripts take a huge amount of time to run, we record these intermediately numerical results so that 
          one can use the R codes 'figC1.r', 'figC2.r', 'figC3ab.r', 'TableC1.r', 'TablesC2C3.r', 'figC4.r', 'figC5.r', 'TableC4.r', and 'TableC5.r' to obtain the final results 
          based on files stored in "./results/Experiment1/SIM1a", "./results/Experiment1/SIM1b", "./results/Experiment1/SIM2a", "./results/Experiment1/SIM2b", "./results/Experiment1/SIM3a", "./results/Experiment1/SIM3b", 
          "./results/Experiment1/SIM4a", "./results/Experiment1/SIM4b", "./results/Experiment2/SIM1", "./results/Experiment2/SIM2", "./results/Experiment2/SIM3", and "./results/Experiment2/SIM4" subfolders.